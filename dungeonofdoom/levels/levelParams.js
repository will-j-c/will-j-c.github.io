const prologue = {
    ...
    text: [
        ...
        "But you are not one to grieve. You are terror of demons, the banisher of undead. You are the light in the darkness. The necromancer will pay for his transgressions.",
...
const levelParams = [
    {
        ...
        endText: "Some text to tell the story",
     }//,
    // {
